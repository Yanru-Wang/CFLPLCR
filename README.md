...
- **LPG%**: The percentage LP gap defined by ($\text{UB}^1$ - v) / UB^1 $\times$ 100%, where $v^* = \max\{v_{\text{SI}}, v_{\text{LSI}}\}$ denotes the best objective value of incumbents under settings B&C+SI and B&C+LSI;
